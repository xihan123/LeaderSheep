$(document).ready(function () {
 ...
 var get_type = $('input:radio[name="get_type"]:checked').val();
  ...
  for (var i = 0; i < frequency; i++) {
   ...
   cache: true,
   type: "get",
   url: "https://cat-match.easygame2021.com/sheep/v1/game/topic_game_over?rank_score=1&rank_state=1&rank_time=300&rank_role=1&skin=1",
   data: {
     t: token,
...
//   QQ209754
  ...
  $("#get_token").click(function () {
    ...
    $.ajax({
      ...
      data: {
        uid: uid,
        t: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..90YMjJ_-Sxpze-NTZqua9ibVYzz7HkpSPs8WeXXCVJY",
        "content-type": "application/json",
        "User-Agent":
          "Mozilla/5.0 (iPhone; CPU iPhone OS 15_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.28(0x18001c26) NetType/WIFI Language/zh_CN"
      },
